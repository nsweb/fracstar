...
CLASS_EQUIP_CPP(MarsCameraCtrl_Fly);

MarsCameraCtrl_Fly::MarsCameraCtrl_Fly() :
	m_pTargetPlanet(nullptr)
{

}


void MarsCameraCtrl_Fly::UpdateView( CameraView& CamView, float DeltaSeconds )
{
...
bool MarsCameraCtrl_Fly::OnControllerInput( Camera* pCamera, ControllerInput const& Input )
{
